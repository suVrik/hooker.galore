...
public:
    explicit EditorPropertyEditorSystem(World& world);
    void update(float elapsed_time) override;

private:
    void edit_entities(EditorSelectionSingleComponent& editor_selection_single_component) const;
    ...
    void show_save_as_preset_popup() const;
    bool list_properties(EditorSelectionSingleComponent& editor_selection_single_component,
                         const std::string& name, std::vector<entt::meta_any>& objects, bool is_component) const;
};
