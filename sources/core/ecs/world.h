...
public:
    ...
    entt::meta_handle assign_move_or_copy(entt::entity entity, entt::meta_handle component) noexcept;
    ...
    entt::meta_handle replace_move_or_copy(entt::entity entity, entt::meta_handle component) noexcept;
    ...
    template <typename T>
    void each_registered_component(entt::entity entity, T callback) const noexcept;

    /** Iterate over all editable components of specified `entity`. */
    template <typename T>
    void each_editable_component(entt::entity entity, T callback) const noexcept;
...
private:
    ...
    bool check_tag_indices(const std::vector<size_t>& require, const std::vector<size_t>& exclusive) noexcept;
